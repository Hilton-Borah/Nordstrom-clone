    ...
    <div>
      ...
      <Flex w="1450px" margin={"auto"} mt="50px" gap="10px">
        ...
        <Box w="1250px">
          ...
          <Text fontWeight={"700"} fontSize="15px" mt="15px" textAlign={"start"}>Men's Clothing</Text>
          <Image borderBottom={"1px solid lightgray"} pb="5px" src="./images/nord37.png" />
          <Flex justifyContent={"space-between"} alignItems="center"><Text fontWeight={"700"} fontSize="18px">{Male.length + " "}products</Text><Select placeholder='Sort by featured' w="250px" mt="20px">
